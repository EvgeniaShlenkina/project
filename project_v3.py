...
widget_radiobutton_1.configure(text="№1", font=my_font, hover="enable", fg_color="green")
widget_radiobutton_2 = ctk.CTkRadioButton(master=root, variable=var_radiobuttons, value=2)
widget_radiobutton_2.configure(text="№2", font=my_font,state = "disabled", hover="enable", fg_color="red")
